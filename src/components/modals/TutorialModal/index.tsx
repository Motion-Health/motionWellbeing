...
const TutorialModal = () => {
  ...
  const [carouselPageIndex, setCarouselPageIndex] = useState<number | undefined>(0)
                  ...
                  <div className={`tutorial-modal-page-image-${pageNumber}`}>
                    ...
                    {screen?.youTubeVideoId && (
                      <iframe
                        width="404"
                        height="280"
                        src={`https://www.youtube.com/embed/${screen.youTubeVideoId}`}
...
const tutorialModalScreens: TutorialModalScreen[] = [
  {
    ...
    paragraph: "Welcome. Watch our short demo video to see how we can help you plan, deliver and rate activities."
  }, 
  {
    ...
    paragraph: "Over 100 person-centred wellbeing activities for you and those that you care for."
  },
  {
    imageSource: "/assets/images/modal/my-planner.png", 
    imageAlt: "Screenshot of 'my planner' screen",
    header: "My planner", 
    paragraph: "Premium members save time and get ahead by using 'My planner' to schedule all of your activities."
  },
  {
    imageSource: "/assets/images/modal/rate-activities.png", 
    imageAlt: "Screenshot of ratings screen",
    header: "Rate activities", 
    paragraph: "Once you've completed an activity give it a rating so we know what to create more of."
  },
  {
