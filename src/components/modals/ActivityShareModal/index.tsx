...
export const ActivityShareModal = ({ toggleShareModalAction, onCloseShareModal }: Props) => {
    ...
    >      
      <Grid container>
        ...
        >
          ...
          <Grid item>
            <img src="/assets/images/og-image.jpg" alt="Image of a Motion group activity" style={{maxWidth: '848px', width: '100%'}}/>
          </Grid>
          ...
          <Grid container>
            <Button
              ...
              onClick={() => {
                window.open('https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fmotionexercise.co.uk', 
                  'newwindow', 
