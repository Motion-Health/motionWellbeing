...
const Index = () => {
  ...
  return (
    <div className="white-background">
      <Head>
        <title>New Name | Motion Marketing</title>
        <meta property="og:url" content="https://www.motion.org.uk" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Motion Marketing | New Name" />
        <meta name="description" content="New Name" />
        <meta property="og:image" content="./og-image.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Motion Marketing | New Name" />
        <meta name="twitter:image" content="./og-image.jpg" />
        <meta property="twitter:description" content="New Name" />
        <link
          rel="stylesheet"
      ...
      <div className={styles.blogHero}>
        <div className={styles.blogHeroContent}>
          ...
          <p>
            ...
            sector is the massive growth which is about to occur. This
            allowsgxfdghdfgh for an opportunity for care homes to grow and
          ...
          <img
            src="/assets/images/blogs/blog13/Image-1.webp"
            alt="Home thingy"
          />
          ...
          <img
            src="/assets/images/blogs/blog13/Image-2.webp"
            alt="Home thingy"
          />
